  ...
  request("http://www.huffingtonpost.com/topic/tech/", function(error, response, html) {
    ...
    $("div#").each(function(i, element) {
      ...
      if (title && link && image) {
        ...
        result.push({title: title, link: link, image: image})
      }
...
router.post("/", function(req, res) {
  ...
  var art = new Article({title: req.body.title, link: req.body.link, image: req.body.image});
...
router.get('/populated/:id', function(req, res) {
  ...
  Article.find({'_id': req.params.id}).populate('comment').exec(function(err, result) {
...
router.post('/articles/:id', function(req, res) {
  ...
  var comment = new Comment({username: req.body.username, body: req.body.body});
